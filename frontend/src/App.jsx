      ...
      <div className="w-[260px] bg-[#171717] hidden md:flex flex-col p-3 flex-shrink-0">
        ...
        <div className="mb-2">
          <button
            ...
            className="flex items-center justify-between w-full px-3 py-2 rounded-lg hover:bg-[#2A2A2A] transition-colors text-sm text-white"
          >
            <div className="flex items-center gap-2">
              ...
              <span className="truncate">{models.find(m => m.id === selectedModel)?.name || 'Select Model'}</span>
            </div>
